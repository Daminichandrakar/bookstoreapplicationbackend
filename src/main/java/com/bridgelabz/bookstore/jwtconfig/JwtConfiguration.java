package com.bridgelabz.bookstore.jwtconfig;
...
public class JwtConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			...
			.disable()
			.authorizeRequests()
			.antMatchers("/token","/signup" ,"/forget-password/{emailId}","/reset-password","/id/{token}", "/order/listoforders/{userId}","/order/placeorder/{userId}","bookstore/books/{pagenumber}").permitAll()
